...
pub const TcpConnection = struct {
    ...
    pub fn connectToTarget(self: *TcpConnection) !bool {
        ...
        // const timeout = posix.timeval{ .sec = 60, .usec = 500_000 };
        // try posix.setsockopt(target_stream.handle, posix.SOL.SOCKET, posix.SO.RCVTIMEO, &std.mem.toBytes(timeout));
        return true;
    }
